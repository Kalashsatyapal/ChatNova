...
// 🌐 Root Welcome Route
app.get("/", (req, res) => {
  res.send(`<!DOCTYPE html><html><head><title>ChatNova API</title></head><body style="font-family:Arial;text-align:center;margin-top:50px;"><h1>🚀 Welcome to ChatNova Backend API</h1><p>Your server is up and running!</p></body></html>`);
});
